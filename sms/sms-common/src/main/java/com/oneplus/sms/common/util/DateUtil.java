...
public class DateUtil
{
    ...
    public static void main(String[] args){
    	...
    	//System.out.println("getNextDay(new Date(),-365)= "+date);
    	//System.out.println("getNextDay(new Date(),-365)= "+dateStr);
    	...
    	//System.out.println(dateToDateString(new Date(),TIMEF_FORMAT));
    	System.out.println(getCurrentStringDate(TIMEF_FORMAT));
    }
}