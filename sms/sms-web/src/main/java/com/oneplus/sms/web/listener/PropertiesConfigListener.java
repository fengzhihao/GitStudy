package com.oneplus.sms.web.listener;
...
public class PropertiesConfigListener implements ServletContextListener {
	...
	public void contextInitialized(ServletContextEvent sce) {
		...
		try {
			...
			Document doc = db.parse(getClass().getClassLoader().getResource("spring/applicationContext-all.xml").toString());
			...
			throw new RuntimeException("初始化CSS系统变量时出错",e);
		}
	}
