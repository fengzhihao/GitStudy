...
Result findBankAcctDetailInfo(BankAcctDTO bankAcctDTO);
	...
	<form name="inputForm" action="findBankAcctDetailInfo.action" method="post" target="_self">
		<table>
			<tr>
				<td>客户银行卡账号表ID:</td>
		...
		<table>
			<tr>
				<td>*客户ID:</td>
				<td><input name="custId" value='<s:property value="result.bankAcct.custId"/>'/></td>
			</tr>
			<tr>
				<td>*客户银行卡号:</td>
