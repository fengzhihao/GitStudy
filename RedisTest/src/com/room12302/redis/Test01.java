...
public class Test01 {
	public static void main(String[] args) {
		...
		// 将value追加到key原来值的末尾
		System.out.println(jedis.append("apple", "/hk"));
		System.out.println(jedis.get("apple"));
		...
		// 向class中添加元素，100用于排序
		System.out.println(jedis.zadd("class", 100, "老马"));
		System.out.println(jedis.zadd("class", 100, "老马dd"));
		...
		System.out.println(jedis.zcard("class"));
		jedis.zrem("class", "老马dd");
		System.out.println(jedis.zrange("class", 0, -1));
